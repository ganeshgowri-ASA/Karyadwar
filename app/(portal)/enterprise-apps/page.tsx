    ...
    <div className="p-4 md:p-6 max-w-screen-xl mx-auto">
      ...
      <div className="mb-5">
        ...
        <p className="text-gray-500 text-sm mt-0.5">
          Global enterprise systems available across all manufacturing sites
        </p>
      </div>
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-4 mb-5">
        <div className="flex gap-3 flex-wrap">
          <input
            ...
            className="flex-1 min-w-48 border border-gray-300 rounded-lg px-3.5 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
          {(search || activeLetter) && (
            <button
      ...
      <div className="flex items-center gap-4 mb-5 text-sm text-gray-600">
        ...
        {(search || activeLetter) && <span className="text-blue-600">— filtered</span>}
      </div>
          ...
          {Object.entries(grouped).map(([letter, letterApps]) => (
            <div key={letter} id={`letter-${letter}`}>
              <div className="flex items-center gap-3 mb-4">
                <div className="w-9 h-9 bg-blue-800 text-white rounded-lg flex items-center justify-center font-bold text-lg">
                  {letter}
                </div>
